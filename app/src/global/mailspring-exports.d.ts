...
export type SmartInboxCountsStore = typeof import('../flux/stores/smart-inbox-counts-store').default;
export const SmartInboxCountsStore: SmartInboxCountsStore;
...
export * from '../flux/models/smart-inbox';
export type SmartInbox = typeof import('../flux/models/smart-inbox');
export const SmartInbox: SmartInbox;
